...
Finally, this application is being hosted in Firebase's free app hosting.  Continuous Integration is stup with Travis CI.  And simply doing a commit or merge to Master will initiate Travis to do a Build and then a `firebase deploy` after it is done.  This will deploy to the url: https://giftable.firebaseapp.com
